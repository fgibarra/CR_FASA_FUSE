...
public class GeneraRequestCalculateDiscount implements Processor {
	...
	public void process(Exchange exchange) throws Exception {
		...
		if (descuentosRequest.promoVar != null)
			for (Promovar promovar : descuentosRequest.promoVar) {
				Long code = promovar.getPromovar();
				if (code != null) {
					cupones.add(new Coupon(code.toString(), null, null));
				}
			}
